...
(function () {
  ...
  /* Shared pricing — single source of truth in js/prices.js */
  var IRAC = window.IRAC || {};
  var calcDays = IRAC.calcDays;
  var formatPrice = IRAC.formatPrice;
  var lookupPrice = IRAC.lookupPrice;
